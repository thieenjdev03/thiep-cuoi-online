...
Trang riêng `/lich-tet`: chọn ảnh JPG/PNG/WebP tối đa 25 MB, căn vị trí và phóng to, chọn năm 1900–2100, sửa lời chúc rồi tải PNG 3543×5008 px (khổ in 300×424 mm @ 300 DPI, có chunk pHYs nên nhà in đọc đúng 300 DPI thay vì 72 DPI). Ảnh được xử lý bằng Canvas trên thiết bị, không gửi lên server; tải lại trang sẽ đặt lại bản chỉnh sửa. Lịch dương 12 tháng, Chủ nhật màu đỏ; chưa có ngày âm. Hoa đào là hình vector vẽ bằng Canvas, bố cục lấy cảm hứng từ lịch treo ảnh.
...
Happy Wedding có tên cặp đôi, ngày cưới tùy chọn và lời chúc; mặc định không có lịch, có thể bật lịch 12 tháng bên dưới ảnh. PNG vẫn là 3543×5008 px (300×424 mm @ 300 DPI). Trình chỉnh sửa hiển thị DPI thật của ảnh yếu nhất và cảnh báo khi dưới 250 DPI: muốn in nét, ảnh gốc cho bố cục 1 ảnh nên rộng từ 3543 px trở lên (4 ảnh ~1680 px, 6 ảnh ~1100 px mỗi ô). Ảnh và bản chỉnh sửa chỉ tồn tại trong phiên trang hiện tại, không lưu lên server. Bài kiểm tra `npx tsx scripts/test-calendar.ts` bao gồm cả vị trí khung 1/4/6 ảnh và crop ảnh ngang/dọc.
